# From Dennis Gläser's work <dennis.glaeser@iws.uni-stuttgart.de>
#
...
class PhysicalIndexMapper:
    ...
    def _project_to_model_for_index_queries(self, position: tuple) -> tuple:
        ...
        return (position[0],position[1],0) # imposed to be 2d for A & B
...
if __name__ == "__main__":
    ...
    #TODO replace by proper gmsh api call
    ...
    #re-read and write a MRST-readable format
    gmsh.open(msh_file_name)
    gmsh.write(msh_file_name.split('.')[0]+'.m')